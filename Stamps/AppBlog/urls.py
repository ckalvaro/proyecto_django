...
from AppBlog.views import inicio, noticia_detalle_view, form_noticias, editar_noticia, eliminar_noticia, form_usuarios, usuarios, eliminar_usuario, editar_usuario
app_name = 'AppBlog'
urlpatterns = [
